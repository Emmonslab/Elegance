...
public TwoDCurveName(String name, int[] continNums, String dtype,int zoom,int stroke)throws SQLException,
...
public TwoDCurveName(int[] continNums, String dtype,int zoom,int stroke)throws SQLException,
ClassNotFoundException, java.lang.InstantiationException, java.lang.IllegalAccessException
