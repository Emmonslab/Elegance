...
public TwoDCurve2(int[] continNums, String dtype,int zoom,int stroke)throws SQLException,
...
// find out the max and min X and Y
  ...
  jsql = "select max(z1),min(z1) from display2 where ";
		...
		if (minSection<13671) minSection=13671;
		if (maxSection>14694) maxSection=14694;
