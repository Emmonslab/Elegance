	...
	public static void main(String[] args) 
	{
        ...
        String username = "travis";
             ...
             try{
		         ...
		         jsql = "select OBJ_Name from object where username='"+username+"'";
		         ...
		         jsql = "select * from object where username='"+username+"' and type<>'chemical' and type<>'electrical'";
		         rs = st.executeQuery(jsql);
		         while(rs.next())
		         {
...
// insert the new connectivity
			   ...
			   //update synapses record
			    ...
			    st = con.createStatement();
		        jsql = "select * from object where username='"+username+"' and type<>'cell' and type<>'cell branch point'";
		        rs = st.executeQuery(jsql);
		        while(rs.next())
		         {
